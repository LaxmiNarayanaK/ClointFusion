...
cf.scrape_save_contents_to_notepad('C:/Users/Anu/clointfusion/Task-5')
cf.browser_quit_h()


cf.launch_any_exe_bat_application('C:/Users/Anu/clointfusion/Task-5/notepad-contents.txt')
cf.key_press('ctrl+a')
cf.key_press('ctrl+c')
cf.window_close_windows('notepad')
cf.excel_create_file("C:/Users/Anu/clointfusion/Task-5","notepadtoexcel")

cf.launch_any_exe_bat_application('C:/Users/Anu/clointfusion/Task-5/notepadtoexcel.xlsx')
cf.key_press('ctrl+v')
cf.key_press('ctrl+s')
cf.key_press('alt+f3')
...
for j in range(5):
    ...
    From_currency = cf.excel_get_single_cell('C:/Users/Anu/clointfusion/Task-5/notepadtoexcel.xlsx',columnName="From",cellNumber=j)
    To_currency=cf.excel_get_single_cell('C:/Users/Anu/clointfusion/Task-5/notepadtoexcel.xlsx',columnName="To",cellNumber=j)
    Amount=str(cf.excel_get_single_cell('C:/Users/Anu/clointfusion/Task-5/notepadtoexcel.xlsx',columnName="Amount",cellNumber=j))
    # print(From_currency)
    # print(To_currency)
    # print(Amount)
    time.sleep(3)
    ...
    print(Amount[0])
    cf.excel_set_single_cell('C:/Users/Anu/clointfusion/Task-5/notepadtoexcel.xlsx',columnName="Converted",cellNumber=j,setText=Amount[0])
cf.browser_quit_h()
...
#SIgnin outlook
cf.key_write_enter("laxminarayana.clointfusion@outlook.com")
...
time.sleep(2)
cf.key_write_enter(r'C:\Users\Anu\clointfusion\Task-5\notepadtoexcel.xlsx')
