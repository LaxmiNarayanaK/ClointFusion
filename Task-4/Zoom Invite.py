...
cf.launch_any_exe_bat_application(r"C:\Users\Anu\clointfusion\Task-4\Email.xlsx")
cf.key_press('alt+f3')
...
version = cf.excel_get_single_cell(excel_path=r"C:\Users\Anu\clointfusion\Task-4\Email.xlsx", columnName="Hackathon version", cellNumber=0)
date = cf.excel_get_single_cell(excel_path=r"C:\Users\Anu\clointfusion\Task-4\Email.xlsx", columnName="Date", cellNumber=0)


#Changing the hackathon version and date in the given text file
cf.launch_any_exe_bat_application(r"C:\Users\Anu\clointfusion\Task-4\Email.txt") 
cf.key_press('ctrl+h')
...
row_col=cf.excel_get_row_column_count(r"C:\Users\Anu\clointfusion\Task-4\Email.xlsx")
rows=row_col[0]-1
name='Folks'
for i in range(rows):
    cf.launch_any_exe_bat_application(r"C:\Users\Anu\clointfusion\Task-4\Email.txt") 
    ...
    cf.key_press('tab')
    name=cf.excel_get_single_cell(excel_path=r"C:\Users\Anu\clointfusion\Task-4\Email.xlsx", columnName="Name", cellNumber=i)
    cf.key_write_enter(name)
    cf.key_hit_enter()
    for j in range(4):
        cf.key_press('tab')
    ...
    time.sleep(2)
    emailid=cf.excel_get_single_cell(excel_path=r"C:\Users\Anu\clointfusion\Task-4\Email.xlsx", columnName="Email Id", cellNumber=i)
